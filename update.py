...
class TicTacToeApp:
    def __init__(self, master):
        ...
        pygame.mixer.init()
        self.win_sound = pygame.mixer.Sound("D:/Game/sounds/win_sound.wav")
        self.tease_sound = pygame.mixer.Sound("D:/Game/sounds/tease_sound.wav")
    ...
    def win_animation(self):
        # Play winning sound
        self.win_sound.play()
        # You can add your winning animation code here using pygame
        # For example, display a victory message or animation on the screen
    
    def tease_animation(self):
        # Play teasing sound
        self.tease_sound.play()
        # You can add your teasing animation code here using pygame
        # For example, display a teasing message or animation on the screen
...
def main():
    ...
    root = tk.Tk()
    # Create an instance of the TicTacToeApp class
